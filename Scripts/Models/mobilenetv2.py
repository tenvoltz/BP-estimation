# Retreived from https://github.com/tonylins/pytorch-mobilenet-v2/blob/master/MobileNetV2.py
...
class MobileNetV2(nn.Module):
    def __init__(self, output_size=1024, input_size=1024, width_mult=1.):
